...
function animate() {
  ...
  circles.forEach(function (circle) {
    circle.update();
    circle.x = Object(_chriscourses_perlin_noise__WEBPACK_IMPORTED_MODULE_1__["noise"])(time1 + circle.offSet + offset.x) * canvas.width;
    circle.y = Object(_chriscourses_perlin_noise__WEBPACK_IMPORTED_MODULE_1__["noise"])(time2 + circle.offSet) * canvas.height;
  });
  time1 += 0.003;
  time2 += 0.005;
}
